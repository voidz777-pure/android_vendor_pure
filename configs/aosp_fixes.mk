...
ifneq ($(filter nexus_deb nexus_hammerhead nexus_flo nexus_shamu nexus_tuna,$(TARGET_PRODUCT)),)
PRODUCT_COPY_FILES += \
...
ifneq ($(filter nexus_debnexus_hammerhead nexus_flo nexus_shamu nexus_tuna,$(TARGET_PRODUCT)),)
PRODUCT_COPY_FILES +=  \
